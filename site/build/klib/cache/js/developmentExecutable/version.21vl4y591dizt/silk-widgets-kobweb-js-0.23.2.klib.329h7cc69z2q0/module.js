(function (factory) {
  ...
  var Companion_getInstance_0 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.i4;
  ...
  var Companion_getInstance_6 = kotlin_com_varabyte_kobweb_kobweb_core.$_$.l;
  ...
  var Companion_getInstance_7 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.j4;
  ...
  var Companion_getInstance_8 = kotlin_com_varabyte_kobweb_compose_html_ext.$_$.q4;
  ...
  var get_entries = kotlin_com_varabyte_kobweb_silk_foundation.$_$.u1;
  var get_cssClass = kotlin_com_varabyte_kobweb_silk_foundation.$_$.v1;
  ...
  var ColorGroup = kotlin_com_varabyte_kobweb_silk_foundation.$_$.p1;
  var KMutableProperty1 = kotlin_kotlin.$_$.bd;
  var MutablePalette = kotlin_com_varabyte_kobweb_silk_foundation.$_$.q1;
  var com_varabyte_kobweb_silk_theme_colors_palette_MutablePalette_ColorGroup$stableprop_getter = kotlin_com_varabyte_kobweb_silk_foundation.$_$.r1;
  var com_varabyte_kobweb_silk_theme_colors_palette_MutablePalette_ColorGroup_EntryDelegate$stableprop_getter = kotlin_com_varabyte_kobweb_silk_foundation.$_$.s1;
  //endregion
  ...
  initMetadataForClass(ImageLoading, 'ImageLoading', VOID, Enum);
  initMetadataForClass(ImageDecoding, 'ImageDecoding', VOID, Enum);
  initMetadataForClass(ImageFetchPriority, 'ImageFetchPriority', VOID, Enum);
  ...
  function Image(src, modifier, variant, width, height, alt, loading, decoding, fetchPriority, ref, $composer, $changed, $default) {
    _init_properties_Image_kt__h9v8mh();
    ...
    $composer_0 = $composer_0.startRestartGroup_lebv1i_k$(-211707950);
    var $dirty = $changed;
    if (($changed & 6) === 0)
    ...
    if (!(($default & 512) === 0))
      ...
      $dirty = $dirty | ((($changed & 1073741824) === 0 ? $composer_0.changed_ga7h3f_k$(ref_0._v) : $composer_0.changedInstance_s1wkiy_k$(ref_0._v)) ? 536870912 : 268435456);
    if ($composer_0.shouldExecute_4fplh_k$(!(($dirty & 306783379) === 306783378), $dirty & 1)) {
      ...
      if (!(ref_0._v == null)) {
        $composer_0.startReplaceGroup_5hh8aj_k$(-1979155367);
        ...
        var dispatchReceiver = rememberComposableLambda(-1360541896, true, Image$lambda(ref_0), $composer_0, 54);
        ...
        $composer_0.startReplaceGroup_5hh8aj_k$(-1982791760);
        $composer_0.endReplaceGroup_ek144q_k$();
      }
      var tmp_9 = Companion_getInstance_6().prependTo_e25c5r_k$(src);
      var tmp_10 = alt_0._v;
      var tmp_11 = toModifier(get_ImageStyle(), [variant_0._v], $composer_0, com_varabyte_kobweb_silk_style_CssStyle$stableprop_getter() | com_varabyte_kobweb_silk_style_CssStyleVariant$stableprop_getter() << 3).then_mmfvo6_k$(modifier_0._v);
      ...
      if (invalid_0 || it_0 === Companion_getInstance_5().get_Empty_i9b85g_k$()) {
        var value_0 = Image$lambda_0(width_0, height_0, loading_0, decoding_0, fetchPriority_0);
    ...
    if (tmp0_safe_receiver == null)
      ...
      tmp0_safe_receiver.updateScope_t8jcf_k$(Image$lambda_1(src, modifier_0, variant_0, width_0, height_0, alt_0, loading_0, decoding_0, fetchPriority_0, ref_0, $changed, $default));
    }
  }
  var ImageLoading_Eager_instance;
  var ImageLoading_Lazy_instance;
  function values() {
    return [ImageLoading_Eager_getInstance(), ImageLoading_Lazy_getInstance()];
  }
  function valueOf(value) {
    switch (value) {
      case 'Eager':
        return ImageLoading_Eager_getInstance();
      case 'Lazy':
        return ImageLoading_Lazy_getInstance();
      default:
        ImageLoading_initEntries();
  ...
  var ImageLoading_entriesInitialized;
  function ImageLoading_initEntries() {
    if (ImageLoading_entriesInitialized)
      return Unit_getInstance();
    ImageLoading_entriesInitialized = true;
    ImageLoading_Eager_instance = new ImageLoading('Eager', 0);
    ImageLoading_Lazy_instance = new ImageLoading('Lazy', 1);
  }
  var $ENTRIES;
  function ImageLoading(name, ordinal) {
    Enum.call(this, name, ordinal);
  }
  protoOf(ImageLoading).toString = function () {
    // Inline function 'kotlin.text.lowercase' call
    // Inline function 'kotlin.js.asDynamic' call
    return this.get_name_woqyms_k$().toLowerCase();
  };
  var ImageDecoding_Sync_instance;
  var ImageDecoding_Async_instance;
  var ImageDecoding_Auto_instance;
  function values_0() {
    return [ImageDecoding_Sync_getInstance(), ImageDecoding_Async_getInstance(), ImageDecoding_Auto_getInstance()];
  }
  function valueOf_0(value) {
    switch (value) {
      case 'Sync':
        return ImageDecoding_Sync_getInstance();
      case 'Async':
        return ImageDecoding_Async_getInstance();
      case 'Auto':
        return ImageDecoding_Auto_getInstance();
      default:
        ImageDecoding_initEntries();
        THROW_IAE('No enum constant value.');
        break;
    }
  }
  ...
  var ImageDecoding_entriesInitialized;
  function ImageDecoding_initEntries() {
    if (ImageDecoding_entriesInitialized)
      return Unit_getInstance();
    ImageDecoding_entriesInitialized = true;
    ImageDecoding_Sync_instance = new ImageDecoding('Sync', 0);
    ImageDecoding_Async_instance = new ImageDecoding('Async', 1);
    ImageDecoding_Auto_instance = new ImageDecoding('Auto', 2);
  }
  var $ENTRIES_0;
  function ImageDecoding(name, ordinal) {
    Enum.call(this, name, ordinal);
  }
  protoOf(ImageDecoding).toString = function () {
    // Inline function 'kotlin.text.lowercase' call
    // Inline function 'kotlin.js.asDynamic' call
    return this.get_name_woqyms_k$().toLowerCase();
  };
  var ImageFetchPriority_High_instance;
  var ImageFetchPriority_Low_instance;
  var ImageFetchPriority_Auto_instance;
  function values_1() {
    return [ImageFetchPriority_High_getInstance(), ImageFetchPriority_Low_getInstance(), ImageFetchPriority_Auto_getInstance()];
  }
  function valueOf_1(value) {
    switch (value) {
      case 'High':
        return ImageFetchPriority_High_getInstance();
      case 'Low':
        return ImageFetchPriority_Low_getInstance();
      case 'Auto':
        return ImageFetchPriority_Auto_getInstance();
      default:
        ImageFetchPriority_initEntries();
        THROW_IAE('No enum constant value.');
        break;
    }
  }
  ...
  var ImageFetchPriority_entriesInitialized;
  function ImageFetchPriority_initEntries() {
    if (ImageFetchPriority_entriesInitialized)
      return Unit_getInstance();
    ImageFetchPriority_entriesInitialized = true;
    ImageFetchPriority_High_instance = new ImageFetchPriority('High', 0);
    ImageFetchPriority_Low_instance = new ImageFetchPriority('Low', 1);
    ImageFetchPriority_Auto_instance = new ImageFetchPriority('Auto', 2);
  }
  var $ENTRIES_1;
  function ImageFetchPriority(name, ordinal) {
    Enum.call(this, name, ordinal);
  }
  protoOf(ImageFetchPriority).toString = function () {
    // Inline function 'kotlin.text.lowercase' call
    // Inline function 'kotlin.js.asDynamic' call
    return this.get_name_woqyms_k$().toLowerCase();
  };
  ...
  function Image$lambda_0($width, $height, $loading, $decoding, $fetchPriority) {
    return function ($this$toAttrs) {
      ...
      var tmp_1;
      if (!($loading._v == null)) {
        $this$toAttrs.attr_w68641_k$('loading', $loading._v.toString());
        tmp_1 = Unit_getInstance();
      }
      var tmp_2;
      if (!($decoding._v == null)) {
        $this$toAttrs.attr_w68641_k$('decoding', $decoding._v.toString());
        tmp_2 = Unit_getInstance();
      }
      var tmp_3;
      if (!($fetchPriority._v == null)) {
        $this$toAttrs.attr_w68641_k$('fetchpriority', $fetchPriority._v.toString());
        tmp_3 = Unit_getInstance();
      }
      return Unit_getInstance();
    };
  }
  function Image$lambda_1($src, $modifier, $variant, $width, $height, $alt, $loading, $decoding, $fetchPriority, $ref, $$changed, $$default) {
    return function ($composer, $force) {
      Image($src, $modifier._v, $variant._v, $width._v, $height._v, $alt._v, $loading._v, $decoding._v, $fetchPriority._v, $ref._v, $composer, updateChangedFlags($$changed | 1), $$default);
      return Unit_getInstance();
    };
  }
  function ImageLoading_Eager_getInstance() {
    ImageLoading_initEntries();
    return ImageLoading_Eager_instance;
  }
  function ImageLoading_Lazy_getInstance() {
    ImageLoading_initEntries();
    return ImageLoading_Lazy_instance;
  }
  function ImageDecoding_Sync_getInstance() {
    ImageDecoding_initEntries();
    return ImageDecoding_Sync_instance;
  }
  function ImageDecoding_Async_getInstance() {
    ImageDecoding_initEntries();
    return ImageDecoding_Async_instance;
  }
  function ImageDecoding_Auto_getInstance() {
    ImageDecoding_initEntries();
    return ImageDecoding_Auto_instance;
  }
  function ImageFetchPriority_High_getInstance() {
    ImageFetchPriority_initEntries();
    return ImageFetchPriority_High_instance;
  }
  function ImageFetchPriority_Low_getInstance() {
    ImageFetchPriority_initEntries();
    return ImageFetchPriority_Low_instance;
  }
  function ImageFetchPriority_Auto_getInstance() {
    ImageFetchPriority_initEntries();
    return ImageFetchPriority_Auto_instance;
  }
